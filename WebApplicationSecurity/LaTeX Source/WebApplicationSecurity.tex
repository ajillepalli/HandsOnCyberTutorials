...
A free virtualization software platform for M1 processors - UTM - \href{https://mac.getutm.app/gallery/ubuntu-20-04}{\underline{CLICK ME}}.

Ubuntu 20.04 LTS - Canonical Ltd. - \href{https://releases.ubuntu.com/20.04/}{\underline{CLICK ME}} 

Guide to Installing LAMP on Ubuntu 20.04 LTS - DigitalOcean - \href{https://www.digitalocean.com/community/tutorials/how-to-install-linux-apache-mysql-php-lamp-stack-on-ubuntu-20-04}{\underline{CLICK ME}}

\texttt{bWAPP} by Malik Mesellem - SourceForge - \href{https://sourceforge.net/projects/bwapp/files/bWAPP/}{\underline{CLICK ME}}

{If you do not configure a server IP address for Apache, the default address would be `localhost', which can be accessed through `http://localhost'.}

{Thanks to Funso Oje (Fall 2021 CptS 427 at Washington State University) for testing the tutorial with 20.04 and for the M1 processor guide link.}
