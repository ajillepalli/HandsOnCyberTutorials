...
\begin{document}
	...
	*\texttt{mkpasswd} needs \texttt{whois} as a pre-requisite
	...
	\code{[List.Rules:Wordlist]}\\
	\code{A0"[+]"Az"[8]"}\\ OR \code{$\hat{}$ + \$8}\\\\
	You may also have to clear everything out in the \code{[Options]} category of `john.conf'.
